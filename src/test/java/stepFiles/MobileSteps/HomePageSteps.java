...
public class HomePageSteps {
    ...
    public HomePageSteps(TestContext context) {
        testContext = context;
        homePagePage = testContext.getMobilePageObjectManger().getFirstPage();
    }

    @Given("^user launch the app$")
    public void userLaunchTheApp() throws IOException {
        Assert.assertTrue(testContext.getMobilePageObjectManger().getAndroidDriver().getSessionId() != null, "Application is not launched");
    }
